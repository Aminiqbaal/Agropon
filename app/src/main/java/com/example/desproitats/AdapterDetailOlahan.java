...
public class AdapterDetailOlahan extends RecyclerView.Adapter<AdapterDetailOlahan.ViewHolder> {
    String[][] data;
    String alamat;
    Context context;
    ...
    public AdapterDetailOlahan(Context context, String[][] data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_hasil_olahan, viewGroup, false));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            buy = itemView.findViewById(R.id.buy_olahan_btn);
        }
    }
