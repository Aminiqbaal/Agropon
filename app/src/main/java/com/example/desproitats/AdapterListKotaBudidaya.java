...
public class AdapterListKotaBudidaya extends RecyclerView.Adapter<AdapterListKotaBudidaya.ViewHolder> {
    String[][] data;
    Context context;

    public AdapterListKotaBudidaya(Context context, String[][] data) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,Detail_Budidaya.class);
